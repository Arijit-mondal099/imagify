...
const Login = () => {
  ...
  const { setShowLogin, axios, setToken, setUser, loadCreditData } =
    useAppContext();
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center">
      ...
      >
        <h1 className="text-center text-neutral-700 font-medium text-2xl">
          {state}
        </h1>
        ...
        <button className="bg-blue-600 text-white py-2.5 px-4 w-full rounded-full cursor-pointer hover:bg-blue-500 transition-all duration-100">
          {isLoading ? (
